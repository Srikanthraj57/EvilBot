...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/01efe2bcd59ba04b2bac0.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *𝓵𝓮𝓰𝓮𝓷𝓭 𝓫𝓸𝓽*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text= 😇 𝙊𝙬𝙣𝙚𝙧 😇", url=@Srikanth_36),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="evil_"),
        InlineKeyboardButton(
            text="join", url=https://t.me/we_all_are_best_friends
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/legend_bot_support"),
        InlineKeyboardButton(text="Channel", url="https://t.me/legend_bot_updates"),
    ], 
...
evil_IMG = "https://telegra.ph/file/01efe2bcd59ba04b2bac0.jpg"
